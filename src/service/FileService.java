...
//  }
  ...
  private void addNewCustomer(String contentLine) {
    ...
    try {
      ...
      boolean isActive =  parts[9].equals("true");
  ...
  private void addNewProduct(String contentLine) {
    ...
    try {
      ...
      boolean isInStock =  parts[4].equals("true");
      boolean isActive =  parts[5].equals("true");
      Product newItem = new Product(productId, productName,productDetail, price, isInStock, isActive);
  ...
  private void addNewOrder(String contentLine) {
    ...
    try {
      ...
      boolean isPending =  parts[3].equals("true");
